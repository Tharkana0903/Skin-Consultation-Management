...
public class ConsultationGUI extends JFrame{
    ...
    public ConsultationGUI(ArrayList<Doctor> doctors){
        ...
        bookConsultationButton.setSize(100,45);
        showConsultationButton.setSize(100,45);
        sortDoctorsButton.setSize(100,45);

        bookConsultationButton.setBackground(new Color(255,0,0));
        showConsultationButton.setBackground(new Color(255,100,0));
        sortDoctorsButton.setBackground(new Color(255,200,100));
